package com.ray.retrofit2.widgets;
...
import com.ray.retrofit2.utils.SizeUtils;
...
public class AqiView extends View {
    ...
    private HeAirNow.HeWeather6Bean.AirNowBean aqi;
    ...
    protected void onDraw(Canvas canvas) {
        ...
        int aqiValue = Integer.parseInt(aqi.aqi);
        ...
        float qltyStringWidth = textPaint.measureText(aqi.qlty);
        ...
        textPaint.setColor(Color.WHITE);
        canvas.drawText(aqi.qlty, textRectf.centerX(), baseLineY2, textPaint);
    ...
    public void setAqi(HeAirNow weather) {
        if (weather == null || !canRefresh) {
            return;
        }
        this.aqi = weather.HeWeather6.get(0).air_now_city;
        int apiValue = Integer.parseInt(aqi.aqi);
        int targetColor;
        if (apiValue <= 50) {
