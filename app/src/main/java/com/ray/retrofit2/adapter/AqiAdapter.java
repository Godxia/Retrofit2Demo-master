...
public class AqiAdapter extends BaseQuickAdapter<HeAirNowBean, BaseViewHolder> {
    /**
     ...
     */
    public AqiAdapter(int layoutResId, List<HeAirNowBean> data) {
     ...
     */
    @Override
    protected void convert(BaseViewHolder helper, HeAirNowBean item) {
